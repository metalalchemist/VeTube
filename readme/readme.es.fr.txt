...
[démo de travail du produit] (https://youtu.be/4XawJoBymPs)
## Caractéristiques
...
| archiver un message | altshift à |
| Copiez le message actuel | alt shift c |
| Efface un tampon précédemment créé | alt shift d |
| ajouter un message au tampon des favoris | altshiftf |
| Activer ou désactiver le mode automatique | alt shiftm |
| désactiver les sons du programme | alt-shift p |
| rechercher un mot parmi les messages | altshift s |
...
[télécharger le programme pour 64 bits](https://github.com/metalalchemist/VeTube/releases/download/v2.5/vetube64v2.5.zip)
[télécharger le programme pour 32 bits](https://github.com/metalalchemist/VeTube/releases/download/v2.5/vetube32v2.5.zip)
