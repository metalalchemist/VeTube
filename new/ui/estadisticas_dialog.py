...
class EstadisticasDialog(wx.Dialog):
    def __init__(self, parent, title="Estadísticas del Chat"):
        ...
        self.list_ctrl.InsertColumn(0, 'Autor', width=250)
        self.list_ctrl.InsertColumn(1, 'Cantidad de mensajes', width=150)

        vbox.Add(self.list_ctrl, 1, wx.EXPAND | wx.ALL, 5)

        self.btn_guardar = wx.Button(self.panel, label='Guardar estadísticas')
        self.btn_cerrar = wx.Button(self.panel, id=wx.ID_CANCEL, label='Cerrar')
