...
from globals.resources import codigos_traduccion, idiomas_disponibles, monedas
...
class PanelChat(wx.Panel):
    def __init__(self, parent):
        ...
        self.chk1 = wx.CheckBox(
            self, wx.ID_ANY, _("Activar lectura de mensajes automática")
        )
        self.chk1.SetValue(config["reader"])
        boxSizer_chat.Add(self.chk1, 0, wx.ALL, 5)
        label_monedas = wx.StaticText(
            self, wx.ID_ANY, _("convertir las donaciones a la divisa: ")
        )
