...
Catatan: portal pengembang Discord ditampilkan dalam bahasa akun Discord Anda jika tersedia; jika tidak, dalam bahasa Inggris. Nama tombol di bawah ini diberikan dalam bahasa Inggris sebagai acuan; jika portal Anda diterjemahkan, tombol akan muncul dalam bahasa Anda.
...
2. Tekan tombol "Reset Token" dan konfirmasi dengan "Yes, do it!".
3. Discord lalu meminta kata sandi Anda (atau kunci sandi) sekali lagi untuk memastikan itu Anda: ketik dan konfirmasi. Jika Anda memakai verifikasi dua langkah, kode juga bisa diminta.
4. Token baru muncul dengan tombol "Copy" untuk menyalinnya ke papan klip. Tempelkan sementara di tempat aman, misalnya Notepad: demi keamanan, token hanya ditampilkan sekali, saat dibuat.
...
5. Buka URL itu di peramban dan pilih server Anda pada kotak kombo "Tambahkan ke server". Tips pembaca layar: selama belum ada server yang dipilih, tombol bawah bernama "Anda belum mengisi beberapa kolom"; setelah server dipilih namanya berubah menjadi "Otorisasi". Tekan tombol itu. (Jika Anda tidak boleh mengundang bot, kirim URL itu ke administrator server.)
...
- Discord meminta kata sandi saya saat membuat token: itu normal, itu pemeriksaan keamanan (langkah 2).
