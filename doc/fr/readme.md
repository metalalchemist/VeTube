...
[télécharger le programme portable pour 64 bits](https://github.com/metalalchemist/VeTube/releases/latest/download/vetube-v3.96.zip)
[télécharger le programme d'installation pour 64 bits](https://github.com/metalalchemist/VeTube/releases/latest/download/vetube-v3.96.msi)
[télécharger le programme portable pour 32 bits](https://github.com/metalalchemist/VeTube/releases/download/v3.7/VeTube-x86.zip)
