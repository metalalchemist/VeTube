...
class YouTubeRealTimeService:
    def __init__(self, url, frame, plataforma, title=None, chat_controller=None):
        ...
        if chat_controller:
            ...
            self.chat_controller = ChatController(
                None, frame, self, plataforma
            )  # main_controller is None here, will be set by ChatController.servicio
    ...
    def recibir(self):
        ...
        try:
                    ...
                    if message_type == "donacion":
                        if (
                            ...
                            if (
                                ...
                                and data_store.divisa != currency
                            ):
                            ...
                            wx.CallAfter(
                                self.chat_controller.agregar_mensaje_donacion,
                                full_message,
                            )
                            if (
            ...
            logger.exception(
                "Error fatal en la recepción del chat en tiempo real de YouTube"
            )
