...
class GestorRepositorios(BaseDownloader):
    ...
    def cargar_idiomas_locales(self):
        try:
            ...
            return {
                "success": False,
                "data": _("Error al cargar el archivo de idiomas local."),
            }
    ...
    def guardar_idiomas_locales(self, idiomas):
        try:
            ...
            return {
                "success": False,
                "data": _("Error al guardar el archivo de idiomas local."),
            }
    ...
    async def comprobar_nuevos_y_actualizaciones(self):
        ...
        if not res_loc["success"]:
            return res_loc
        res_rem = await self.obtener_idiomas_remotos()
        if not res_rem["success"]:
            return res_rem
        ...
        actualizaciones = {
            k: v for k, v in remotos.items() if k in locales and locales[k] < v
        }

        if nuevos or actualizaciones:
            return {
                "success": True,
                "data": {"nuevos": nuevos, "actualizaciones": actualizaciones},
            }
        return {
            "success": False,
            "data": _("No hay actualizaciones ni nuevos idiomas disponibles."),
            "error": False,
        }
    ...
    async def descargar_zip(self, idioma, download_dir, progress_callback=None):
        ...
        return {
            "success": False,
            "data": _("Error al descargar el archivo del idioma %s: %s")
            % (idioma, res["data"]),
        }
    ...
    def descomprimir_zip(self, ruta_zip, destino):
        try:
            ...
            return {
                "success": False,
                "data": _("Error al extraer los archivos del idioma."),
            }
    ...
    async def instalar_idioma(self, idioma, version, progress_callback=None):
        ...
        try:
            ...
            return {
                "success": False,
                "data": _("Error inesperado durante la instalación."),
            }
        finally:
