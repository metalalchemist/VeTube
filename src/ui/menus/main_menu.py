...
class MainMenu:
    def __init__(self, parent):
        ...
        self.opcion_0 = self.opciones.Append(
            wx.ID_ANY, _("&Editor de combinaciones de teclado para VeTube")
        )
        ...
        self.manual = self.ayuda.Append(
            wx.ID_ANY, _("¿Cómo usar &vetube? (documentación en línea)")
        )
        self.apoyo = self.ayuda.Append(wx.ID_ANY, _("Únete a nuestra &causa"))
        self.itemPageMain = self.ayuda.Append(
            wx.ID_ANY, _("&Visita nuestra página de github")
        )
