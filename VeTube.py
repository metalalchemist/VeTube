...
def configurar_piper(carpeta_voces):
	...
	if onnx_models is None:
		sinvoces = wx.MessageDialog(None, _('Necesitas al menos una voz para poder usar el sintetizador. ¿Quieres abrir nuestra carpeta de Drive para descargar algunos modelos?'), _("No hay voces instaladas"), wx.YES_NO | wx.ICON_QUESTION)
...
if not isinstance(config['voz'], int):
	leer=configurar_tts("piper")
